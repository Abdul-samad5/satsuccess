                        ...
                        <div className="col-lg-5">
                            <div className="appie-hero-content-2">
                                ...
                                <h1 className="appie-title">
                                    ...
                                    Like Never Before, 
Proven Way To Get You Higher SAT Score, Fast!</h1>
...
<p>Across Africa, SAT candidates lack access to smart and affordable prep.
The available and expensive option is also not generating the score
increase and fast enough. Like never before, you can now smack your SAT,
Ace your score and hug your success.
</p>
                                <p></p>
                                <form action="#">
                                    <div className="input-box">
                                        <input type="text" placeholder="Enter your email address for deals" />
